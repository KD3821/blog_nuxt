...
export default {
  layout: "post_detail",
  components: {Comments, Aside, Header},
  ...
  head() {
    return {
      ...
      meta: [
        ...
        {
          property: "og:url",
          content: `http://127.0.0.1:3000${this.$route.path}`
        },
        {
          property: "og:type",
          content: "website"
        ...
        {
          name: "twitter:site", content: "http://127.0.0.1:3000"
        },
        {
          name: "twitter.title",
          content: `${this.post.title}`
        ...
        },
        {
          ...
          content: "http://127.0.0.1:3000/img"
        }
      ]
    };
  },
